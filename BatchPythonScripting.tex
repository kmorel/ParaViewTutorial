...
\commandline{pvpython}\index{pvpython} and
\commandline{pvbatch}\index{pvbatch}.  They are similar to the
...
\begin{exercise}{Creating a Python Script Trace}
  ...
  \commandline{pvpython} or \commandline{pvbatch} program for totally
