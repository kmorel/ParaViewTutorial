...
% Add a Python function to the index.  This is helpful to announce
% functions that are in a Python script but might not be mentioned
% elsewhere in the text.
\newcommand*{\pyfuncindex}[1]{\index{#1}}

% Placeholder for a Python function.  Sets the right font and creates an
% index entry.
\newcommand*{\pyfunc}[1]{\pyfuncindex{#1}\textpy{#1}}

% Set up environment for python scripts.
\CustomVerbatimEnvironment{python}{Verbatim}{}
\CustomVerbatimEnvironment{pythonpluscommands}{Verbatim}{commandchars=\\\{\}}
...
% Camera view icons
\newcommand{\xPlus}{\icon{pqXPlus32}\xspace}
\newcommand{\xMinus}{\icon{pqXMinus32}\xspace}
\newcommand{\yPlus}{\icon{pqYPlus32}\xspace}
\newcommand{\yMinus}{\icon{pqYMinus32}\xspace}
\newcommand{\zPlus}{\icon{pqZPlus32}\xspace}
\newcommand{\zMinus}{\icon{pqZMinus32}\xspace}
...
\newcommand{\selectBlocks}{\icon{pqGroupExtract24}\xspace}
