...
\begin{exercise}{Modifying Rendering Parameters}
  ...
  \item Turn the Orientation Axis (the axis in the lower left corner of the
    view) off and on.  (This can also be done using an icon that looks
    like the Orientation Axis on the right side of the toolbars on top) 
...
types, and the list grows as more types get added.  following is a list
...
\begin{exercise}{Plot Over a Line in Space}
  ...
  middle button up and down to zoom in and out.  Drag with the middle button
