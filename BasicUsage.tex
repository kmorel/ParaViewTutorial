...
\begin{exercise}{Using Multiple Views}
  ...
  \emph{Viol\`{a}}!  The two cameras are linked; each will follow the other.
...
\item[\selectBlocks Select Blocks] Selects blocks in a
  multi-block data set.  (Shortcut: b)
\end{description}
...
values for the property at specific time instance.  The value for the
