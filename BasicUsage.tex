...
\begin{exercise}{Animating Properties}
  ...
  \begin{inlinefig}
    \includegraphics[width=\linewidth]{images/BuildAnimation1}
  \end{inlinefig}
...
\begin{exercise}{Modifying Animation Track Keyframes}
  ...
  \begin{inlinefig}
    \includegraphics[width=\linewidth]{images/BuildAnimation2}
  \end{inlinefig}
  ...
  smaller again.\footnote{There is a bug in ParaView 3.6.1 where the track
    ...
    changes to the \gui{Start Theta} track, try clicking the \vcrFirst
...
\begin{exercise}{Multiple Animation Tracks}
  ...
  \begin{inlinefig}
    \includegraphics[width=\linewidth]{images/BuildAnimation3}
  \end{inlinefig}
