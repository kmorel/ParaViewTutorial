...
Users Manual is online and is located at \href{http://paraview.org/Wiki/ParaView/Users_Guide/Table_Of_Contents}{The ParaView Users Guide}.  
ParaView also has an online help that can be accessed by simply clicking the \icon{pqHelp32} button in the application.  
